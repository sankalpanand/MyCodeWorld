...
public class OneEditDistance {
	...
	public boolean isOneEditDistance(String str1, String str2)
	{
		...
		// Reason 1: getCellIndex = len1: str1 has finished, str2 has one extra character (append operation)
		// Check if the length difference == 1 
		if(offset == 1)
			return true;

		// Reason 2: Different character encountered. Leave this getCellIndex. Continue from the next one.
		...
		/*
		 * 	If lengthDiff was 0, then we were comparing characters at same getCellIndex.
			If lenDiff was 1, and str1 is still not over, it means different character is found.
			But, characters from next getCellIndex onwards should be same.
		 * */
		...
		// While loop could break because of 2 reasons
		// Reason 1: getCellIndex = len1: str1 has finished
		...
		// This will break the while loop and getCellIndex will never reach till len1
		// If everything went fine, getCellIndex == len1 and the strings will be 1 edit distance apart
		return index == len1;
	}
