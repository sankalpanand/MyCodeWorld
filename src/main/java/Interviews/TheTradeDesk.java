...
public class TheTradeDesk {
    public static void main(String[] args) throws IOException {
//        SetAssociativeCacheRunner.parseInput(System.in);

        OutParam<String> replacementAlgoName = new OutParam<>();
        String line = "1, 2, MRUReplacementAlgo";
        SetAssociativeCache<String, String> cache = createCache(line, replacementAlgoName);

        System.out.println(SetAssociativeCacheFactory.InvokeCacheMethod("Set, Eggs, Ham", cache));
        System.out.println(SetAssociativeCacheFactory.InvokeCacheMethod("Set, Sam, Iam", cache));
        System.out.println(SetAssociativeCacheFactory.InvokeCacheMethod("Set, Green, EggsAndHam", cache));

        System.out.println(SetAssociativeCacheFactory.InvokeCacheMethod("Get, Eggs", cache));
        System.out.println(SetAssociativeCacheFactory.InvokeCacheMethod("Get, Green", cache));
        System.out.println(SetAssociativeCacheFactory.InvokeCacheMethod("ContainsKey, Eggs", cache));
        System.out.println(SetAssociativeCacheFactory.InvokeCacheMethod("ContainsKey, Sam", cache));
        System.out.println(SetAssociativeCacheFactory.InvokeCacheMethod("ContainsKey, Green", cache));
